    ...
    def _ensure_fresh_token(self) -> None:
        ...
        try:
            ...
            if "invalid" in body.lower() or "not valid" in body.lower():
                ...
                raise JobberAuthError("Refresh token inválido. Reconecta con Jobber.") from e
            raise
        oauth.save_token_response(data, account_id=self._account_id, account_name=self._account_name)
        self._load_tokens()
        ...
        for attempt in range(1, MAX_RETRIES + 1):
            ...
            if errors:
                ...
                if "THROTTLED" in codes:
                    ...
                    wait      = min(max(1, (10000 - available) / max(restore, 1)), 30)
